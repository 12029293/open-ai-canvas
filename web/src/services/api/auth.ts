...
export function getAuthSettings() {
    return http.get<{ firstUser: boolean; registrationEnabled: boolean; linuxdoEnabled: boolean; emailEnabled: boolean; emailCodeRequired: boolean; localMode?: boolean }>("/auth/settings");
}
